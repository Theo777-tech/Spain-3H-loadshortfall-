...
def _preprocess_data(data):
    ...
    feature_vector_df['Barcelona_pressure'].values[feature_vector_df['Barcelona_pressure'].values > 1084] = feature_vector_df['Barcelona_pressure'].median()
    feature_vector_df['Valencia_wind_speed'].values[feature_vector_df['Valencia_wind_speed'].values > 1084] = feature_vector_df['Valencia_wind_speed'].median()
